...
<head>
   ...
   <link rel="stylesheet" href="/tienda/css/normalize.css">
...
<body>
   ...
   <header class="header">
      <a href="index.php">
         <img src="/tienda/img/logo.png" alt="Logotipo de Tienda" class="header__logo">
      </a>
   </header>
   <!-- Fin del header -->
   ...
   <!-- Navegación -->
      <nav class="navegacion">
            <a <?php if (strstr($_SERVER['REQUEST_URI'], 'index.php')) echo "class='navegacion__enlace navegacion__enlace--activo'";
                  else { echo "class='navegacion__enlace'"; }?> href="/tienda/index.php">Tienda</a>
            <a <?php if (strstr($_SERVER['REQUEST_URI'], 'nosotros.php')) echo "class='navegacion__enlace navegacion__enlace--activo'";
                  else { echo "class='navegacion__enlace'"; }?> href="/tienda/nosotros.php">Nosotros</a>
            <a <?php if (strstr($_SERVER['REQUEST_URI'], 'contacto.php')) echo "class='navegacion__enlace navegacion__enlace--activo'";
                  else { echo "class='navegacion__enlace'"; }?> href="/tienda/contacto.php">Contáctanos</a>
      </nav>
